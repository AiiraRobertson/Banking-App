    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-xl shadow-sm p-6 text-white">
          <p className="text-sm text-indigo-100">Quick Transfer</p>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <Link key={action.label} to={action.to} className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 text-center hover:shadow-md transition-shadow">
